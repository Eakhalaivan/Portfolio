...
export const GlareCard = ({
  ...
  const backgroundStyle = {
    ...
    "--rainbow":
      "repeating-linear-gradient( 0deg,rgba(0,229,255,1) calc(var(--step) * 1),rgba(0,71,255,1) calc(var(--step) * 2),rgba(139,92,246,1) calc(var(--step) * 3),rgba(6,182,212,1) calc(var(--step) * 4),rgba(59,130,246,1) calc(var(--step) * 5),rgba(168,85,247,1) calc(var(--step) * 6),rgba(0,229,255,1) calc(var(--step) * 7) ) 0% var(--bg-y)/200% 700% no-repeat",
    "--diagonal":
  ...
  return (
    <div
      ...
      className="relative isolate w-full h-full min-h-[450px] transition-transform delay-[var(--delay)] duration-[var(--duration)] ease-[var(--easing)] will-change-transform [contain:layout_style] [perspective:600px]"
      ref={refElement}
      onPointerMove={(event) => {
      ...
      <div
        ...
        <div
          ...
          <div className={cn("h-full w-full bg-[#030014]", className)}>
            {children}
          </div>
        </div>
        <div
