...
class x {
  ...
  #w() {
    ...
    const animate = () => {
      ...
      this.#h.elapsed = this.#c.getElapsed();
  ...
  (function (e, t) {
    if (!b.has(e)) {
      ...
      if (!R) {
        ...
        document.body.addEventListener('touchstart', (e) => TouchStart(e), { passive: false });
        document.body.addEventListener('touchmove', (e) => TouchMove(e), { passive: false });
...
class Z extends d {
  constructor(e, t = {}) {
    ...
    const o = new g();
    const r = new Y({ envMap: n, ...i.materialParams, emissive: 0x000000, emissiveIntensity: 0 });
  ...
  #S() {
    this.ambientLight = new f(this.config.ambientColor, 2.0);
    this.add(this.ambientLight);
    this.light = new u(this.config.colors[0], 500);
    this.add(this.light);
  }
  setColors(e) {
